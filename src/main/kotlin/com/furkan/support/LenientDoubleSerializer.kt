 ...
 *
 * Gerekce: eski istemciler govdeyi tamamen string map olarak gonderiyor olabilir.
 */
object LenientDoubleSerializer : KSerializer<Double?> {

    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.furkan.support.LenientDouble", PrimitiveKind.DOUBLE).nullable
